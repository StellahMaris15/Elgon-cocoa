...
export const inputCls =
  "w-full h-11 px-4 neo-inset text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring/30";
...
export const primaryBtn =
  "btn-label text-[11px] inline-flex items-center gap-2 px-5 py-3 rounded-md bg-primary text-primary-foreground neo-action hover:bg-secondary disabled:opacity-60";

export const ghostBtn =
  "btn-label text-[11px] inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-background text-foreground neo-action hover:text-primary";
